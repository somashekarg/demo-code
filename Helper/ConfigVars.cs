...
namespace OneDirect.Helper
{
    public sealed class ConfigVars
    {
        ...
        private ConfigVars()
        {
			...
			ConnectionString = Utilities.GetPGConnectionString("postgres://trexdbadmin:trex123!@trexrehab-test.c9lpnnzupjh6.us-east-1.rds.amazonaws.com:5432/trexrehabdbtest");
            //staging
