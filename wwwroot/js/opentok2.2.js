...
var PUB_VIDEO_WIDTH = 100;
var PUB_VIDEO_HEIGHT = 100;
var button;
var VIDEO_WIDTH = "100%";
var VIDEO_HEIGHT = ($(window).height() - $(".main-footer").height() - $(".main-header").height() - 90) + "px";
var doctorName = "";
var appid = "";
var sessionid = "";
var uType = "";
...
function endCall(obj, label) {
    ...
    //Prabhu- commented the end call signal called disconnect
    //session.signal({
    //    type: "endcall",
