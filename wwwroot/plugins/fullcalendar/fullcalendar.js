...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    DayGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            //Prabhu
            if (location.pathname.indexOf("Appointments") > 0) {
            ...
            if (location.pathname.indexOf("Appointments") > 0) {
                ...
                return '<a class="' + classes.join(' ') + '"' +
                        ...
                        (skinCss ?
                            ' style="' + skinCss + ';margin-top:10px;"' :
                            ''
                            ) +
                    '>' +
                        '<div class="fc-content" align="center">' +
                            (this.isRTL ?
                ...
                return '<a class="' + classes.join(' ') + '"' +
                        ...
                        (skinCss ?
                            ' style="' + skinCss + ';margin-top:10px;width:15px;"' :
                            ''
                            ) +
                    '>' +
                        '<div class="fc-content" align="center">' +
            ...
            function emptyCellsUntil(endCol) {
                while (col < endCol) {
                    ...
                    if (td) {
                        ...
                        //Prabhu, the below line was td = $('<td/>');
                        //if (location.pathname.indexOf("Appointments") > 0) {
                        //    td = $('<td/>');
                        //}
                        //else {
                        //    td = $('<td/>').append("<a class='fc-day-grid-event fc-event fc-start fc-end fc-draggable' style='background-color:#e52929;border-color:#f56954;margin-top:10px;cursor:default;width:15px;'><div class='fc-content' align='center'> <span class='fc-title'>0</span></div></a>");
                        //}
                        td = $('<td/>');
                        tr.append(td);
                    }
    ...
    setDefaults({
        allDaySlot: true,
        allDayText: 'all-day',
        scrollTime: '10:00:00',//Prabhu - previous it was scrollTime: '06:00:00'
        slotDuration: '01:00:00',
        minTime: '00:00:00',
        maxTime: '24:00:00',
        slotEventOverlap: false //Prabhu- previous it was true
    });
