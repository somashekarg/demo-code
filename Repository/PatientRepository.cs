...
namespace OneDirect.Repository
{
    public class PatientRepository : IPatient
    {
        ...
        public string ClaimPatient(string patientloginid, string SurgeryDate)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(patientloginid) && !string.IsNullOrEmpty(SurgeryDate))
                {
        ...
        public string CreatePIN(string patientloginid, string SurgeryDate, string PIN)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(patientloginid) && !string.IsNullOrEmpty(SurgeryDate) && !string.IsNullOrEmpty(PIN))
                {
        ...
        public string CreateEncryptPIN(string patientloginid, string SurgeryDate, string PIN)
        {
            string result = string.Empty;
            try
            {
        ...
        public Patient GetPatientByPatientLoginId(string patientloginid)
        {
            Patient result = null;
            try
            {
